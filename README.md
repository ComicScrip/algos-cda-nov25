...
- each challenge folder contains a challenge! You'll find for each challenge :
...
_I press Ctrl+S, and I look at the terminal. Something went wrong, I can see that my output is reversed-sorted! That's too bad ! I just have to switch -1 and 1 in my condition!_
